...
const styles = {
  ...
  tooltipContent: 'tooltip-content flex-row text-left gap-1 cursor-default bg-[#171717] rounded-xl border border-[#262626] p-2 relative after:w-2 after:h-2 after:border after:border-[#262626] after:bg-[#171717] after:absolute after:left-1/2 after:origin-center after:-translate-x-1/2 after:-rotate-45',
