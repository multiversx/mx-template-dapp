...
browserFrameTopBar: 'browser-frame-top-bar w-full h-[32px] bg-primary rounded-t-2xl pl-4 py-1 pr-2.5 flex items-center justify-between',
browserFrameTopBarLeft: 'browser-frame-top-bar-left flex gap-2',
browserFrameTopBarLeftDot: 'browser-frame-top-bar-left-dot w-2 h-2 rounded-full bg-icon',
...
browserFrameTopBarRightDot: 'browser-frame-top-bar-right-dot w-0.75 h-0.75 rounded-full bg-icon',
browserFrameScreenBg: 'browser-frame-screen-bg w-full h-[330px] bg-primary rounded-b-2xl px-2 pb-2',
browserFrameScreen: 'browser-frame-screen bg-secondary w-full h-full rounded-2xl'
