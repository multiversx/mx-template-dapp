...
<<<<<<<< HEAD:src/pages/Dashboard/components/Actions/helpers/helpers/useGetPingAmount.ts
import { smartContract } from '../../helpers/smartContract';
========
import { smartContract } from './smartContract';
>>>>>>>> tm-temp:src/pages/Dashboard/components/Actions/helpers/useGetPingAmount.ts
