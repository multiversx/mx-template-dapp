...
// prettier-ignore
const styles = {
  dashboardContainer: 'dashboard-container flex w-screen overflow-hidden min-h-screen relative border-t border-b border-secondary transition-all duration-300',
